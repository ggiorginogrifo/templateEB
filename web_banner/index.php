...
<head>
    ...
    <link href="<?= $base_path ?>/web_banner/cover.css" rel="stylesheet">
</head>
                ...
                <div class="row m-0 elements d-flex align-items-center h-100">
                    ...
                    <div class="col-10 img_container col-xs-10">
                        <div class="col-6 col-xs-6 p-0">
                            <img class="social_img" src="<?= $path_banner_300_250 ?>"> <!-- es. img/banner_square.png -->
                        </div>
                        <div class="col-9 col-xs-9 p-0 mt-5">
                            <img class="social_img" src="<?= $path_banner_468_60 ?>"> <!-- es. img/banner-rect_col-9.png-->
                        </div>
                        <div class="col-12 col-xs-12 p-0 mt-5">
                            <img class="social_img" src="<?= $path_banner_728_90 ?>"> <!-- es. img/banner-rect-col-12.png -->
                        </div>
